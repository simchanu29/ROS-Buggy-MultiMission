...
class key_interpreter():
    def __init__(self):
        ...
        self.max_ang_vel = rospy.get_param('max_ang_vel', 10.0)  # N.m
        self.max_lin_vel = rospy.get_param('max_lin_vel', 10.0)  # N
    ...
    def keys_cb(self, msg, twist_pub):
        ...
        if self.state == self.stateMap['manual']:
            ...
            t.angular.x = 0
            t.angular.y = 0
            t.angular.z = self.angCmd * self.max_ang_vel

            t.linear.x = self.linCmd[0] * self.max_lin_vel
            t.linear.y = self.linCmd[1] * self.max_lin_vel
            t.linear.z = 0
...
if __name__ == '__main__':
    ...
    twist_pub = rospy.Publisher('cmd_wrench', Twist, queue_size=1)
